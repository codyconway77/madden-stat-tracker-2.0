...
const Home: NextPage<IGamesProps> = ({ data }) => {
  ...
  return (
    <div className='grid grid-rows-12 grid-cols-12 w-screen h-screen overflow-hidden bg-stone-800'>
      ...
      <div className='col-start-1 col-end-13 row-start-1 row-end-12 md:row-end-13 md:col-start-2 md:col-end-13 min-h-[550px] flex h-full flex-col justify-center overflow-hidden content-center'>
        <h1 className='text-white hidden md:block text-xl text-center pb-4'>Madden Stat Tracker</h1>
        <div className='col-start-3 col-end-12 row-start-3 row-end-11 place-self-center flex flex-wrap justify-around gap-4 py-4 items-center rounded-2xl w-10/12 h-5/6 bg-white overflow-y-scroll overhflow-x-hidden'>
